...
import com.github.ledoyen.automocker.api.web.HttpStatusMatcher;
import com.github.ledoyen.automocker.api.web.JsonMatchers;
...
public class WebStepDefs {
    ...
    public void response_body_should_match(String expression, String expectedValue) throws Exception {
        lastRequest.andExpect(
                MockMvcResultMatchers
                        .jsonPath(expression, JsonMatchers.is(expectedValue.trim()))
        );
    }
